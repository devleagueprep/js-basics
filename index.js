...
var favSong = 'Bring Da Ruckus';
console.log(favSong);

var favAnimal = 'monkey';
...
var plateLunch = ['Chicken Katsu', 'Loco Moco', 'Korean Fried Chicken', 'Hamburger Steak', 'Mochiko Chicken'];
console.log(plateLunch);

var donutBox = ['jelly', 'regular', 'chocolate', 'long john', 'malasada'];
console.log(donutBox);

var westCoast = ['California', 'Oregon', 'Washington', 'Nevada', 'Idaho'];
console.log(westCoast);

var lotteryResult = [1, 23, 57, 62, 4];
console.log(lotteryResult);

var hamajang = [1, 'a', null, true, undefined, [1, 2]];
console.log(hamajang);

var dynamicDuos = [['Batman', 'Robin'], ['Salt', 'Pepper'], ['Method Man', 'Redman']];
...
var foodResult = makeFood('Salt', 'pepper', 'well seasoned meal');
